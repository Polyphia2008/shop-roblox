<body>
    ...
    <!-- Loader -->
    <div id="loader">
        <img src="https://zshopclone7.cmsnt.net/public/theme/assets/images/media/loader.svg" alt="">
    </div>
    <!-- Loader -->
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <a href="/admin" class="header-logo">
                                <img src="<?=$VCD->site('logo');?>" alt="logo" class="desktop-logo">
                                <img src="<?=$VCD->site('logo');?>" alt="logo" class="toggle-logo">
                                <img src="<?=$VCD->site('logo');?>" alt="logo" class="desktop-dark">
                                <img src="<?=$VCD->site('logo');?>" alt="logo" class="toggle-dark">
                                <img src="<?=$VCD->site('logo');?>" alt="logo"
                                    class="desktop-white">
                                <img src="<?=$VCD->site('logo');?>" alt="logo" class="toggle-white">
                            </a>
                        </div>
                    </div>
                    <!-- End::header-element -->
        ...
        <aside class="app-sidebar sticky" id="sidebar">
            ...
            <div class="main-sidebar-header">
                <a href="/admin" class="header-logo">
                    ...
                    <img src="<?=$VCD->site('logo');?>" alt="logo" class="desktop-dark">
                    <img src="<?=$VCD->site('logo');?>" alt="logo" class="toggle-dark">
                    <img src="<?=$VCD->site('logo');?>" alt="logo" class="desktop-white">
                    <img src="<?=$VCD->site('logo');?>" alt="logo" class="toggle-white">
                </a>
            </div>
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    <div class="slide-left" id="slide-left">
                        ...
                        <li class="slide">
                          ...
                          <li class="slide__category"><span class="category-name">Bán Robux</span></li>
                                                <li
                            class="slide has-sub ">
                            <a href="javascript:void(0);"
                                class="side-menu__item ">
                                <i class='bx bx-store side-menu__icon'></i>
                                <span class="side-menu__label">Sell Robux</span>
                                <i class="fe fe-chevron-right side-menu__angle"></i> 
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide">
                                    <a href="/admin/muc-rate"
                                        class="side-menu__item "> Danh Sách Rate</a>
                                </li>
                                <li class="slide">
                                    <a href="/admin/nick-robux"
                                        class="side-menu__item ">Tài khoản nạp Robux</a>
                                </li>
                     ...
                     <li class="slide">
                            <a href="/admin/history-rb"
                                class="side-menu__item ">
                              <i class="bx bx-history side-menu__icon"></i>
                                <span class="side-menu__label">Lịch sử mua Robux</span>
                            </a>
                        </li>
                          <li class="slide">
                            <a href="/admin/ticket"
                                class="side-menu__item ">
                              <i class="bx bx-history side-menu__icon"></i>
                                <span class="side-menu__label">Số Đơn Báo Lỗi [<?=format_cash($VCD->num_rows("SELECT * FROM `ticket` WHERE `status`='1' AND `dichvu`='nick'"))?>]</span>
                            </a>
                        </li>
                             <li class="slide__category"><span class="category-name">Order Robux</span></li>
                                                <li
                            class="slide has-sub ">
                            <a href="javascript:void(0);"
                                class="side-menu__item ">
                                <i class='bx bx-store side-menu__icon'></i>
                                <span class="side-menu__label">order Robux</span>
                                <i class="fe fe-chevron-right side-menu__angle"></i> 
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide">
                                    <a href="/admin/order-rate"
                                        class="side-menu__item "> Rate order</a>
                                </li>
                                <li class="slide">
                                    <a href="/admin/order-robux"
                                        class="side-menu__item ">Tài khoản order Robux</a>
                                </li>
                     ...
                     <li class="slide">
                            <a href="/admin/history-order"
                                class="side-menu__item ">
                              <i class="bx bx-history side-menu__icon"></i>
                                <span class="side-menu__label">Lịch sử order Robux</span>
                            </a>
                        </li>
                          <li class="slide">
                            <a href="/admin/ticket-order"
                                class="side-menu__item ">
                              <i class="bx bx-history side-menu__icon"></i>
                                <span class="side-menu__label">Số Đơn Báo Lỗi [<?=format_cash($VCD->num_rows("SELECT * FROM `ticket` WHERE `status`='1' AND `dichvu`='order' "))?>]</span>
                            </a>
                        </li>
                        <li class="slide__category"><span class="category-name"> Bán Tài Khoản</span></li>
                            ...
                            <ul class="slide-menu child1">
                             ...
                             <li class="slide">
                                    <a href="/admin/chuyen-muc"
                                        class="side-menu__item ">Chuyên mục</a>
                                </li>
                                <li class="slide">
                                    <a href="/admin/product"
                                        class="side-menu__item ">Sản phẩm</a>
                                </li>
                                <li class="slide">
                                    <a href="/admin/don-hang"
                                        class="side-menu__item ">Đơn hàng</a>
                                </li>
                            ...
                            <ul class="slide-menu child1">
                                <li class="slide">
                                    <a href="/admin/ListBank"
                                        class="side-menu__item ">Ngân
                                        hàng</a>
                                </li>
                                <!--<li class="slide">-->
                                <!--    <a href="/admin/recharge-card"-->
                                <!--        class="side-menu__item ">Nạp thẻ cào</a>-->
                                <!--</li>-->
                            </ul>
                        </li>
                        <!--                                                <li-->
                        ...
                        <!--                class="side-menu__item ">Viết bài mới</a>-->
                        <!--        </li>-->
                        <!--        <li class="slide">-->
                        <!--            <a href="/admin/news"-->
                        <!--                class="side-menu__item ">Tất cả bài-->
                        <!--                viết</a>-->
                        <!--        </li>-->
                        <!--    </ul>-->
                        <!--</li>-->
