...
!function(t, e) {
    ...
    var Ot = {
      ...
      , jt = function(t) {
        if (t.input)
            if (Rt[t.input]) {
                ...
                P("Unexpected type of input! Expected ".concat(Object.keys(Rt).join(" | "), ', got "').concat(t.input, '"'))
    }
      , Mt = function(t, e) {
        var n = ot(D(), t);
        if (n)
      ...
      , Rt = {};
    Rt.text = Rt.email = Rt.password = Rt.number = Rt.tel = Rt.url = Rt.search = Rt.date = Rt["datetime-local"] = Rt.time = Rt.week = Rt.month = function(t, e) {
    ...
    var we = function(t) {
      ...
      , Oe = function(e, n) {
        ...
        if (o) {
            ...
            O(n.inputOptions) || j(n.inputOptions) ? (Be(U()),
    ...
    var je = function e(n) {
      ...
      , He = function(t, e) {
        ...
        if (n.input) {
            ...
            t.showValidationMessage(n.validationMessage)) : "deny" === e ? qe(t, i) : _e(t, i)
        } else
      ...
      , De = function(t, e, n) {
        ...
        Promise.resolve().then((function() {
            ...
            t.enableButtons(),
            t.enableInput(),
            o ? t.showValidationMessage(o) : "deny" === n ? qe(t, e) : _e(t, e)
        }
        ))
    }
      , qe = function(t, e) {
    ...
    var Tn, xn = function(t) {
        ...
        argsToParams: function(e) {
            var n = {};
            return "object" !== t(e[0]) || An(e[0]) ? ["title", "html", "icon"].forEach((function(o, i) {
                var r = e[i];
        ...
        t
    }(), Ln = ["swal-title", "swal-html", "swal-footer"], jn = function(e) {
        var n = {};
