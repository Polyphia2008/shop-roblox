...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0"><i class="fa-solid fa-tags"></i> Tài khoản đã bán</h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item active" aria-current="page">Tài khoản đã bán</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mb-3">
                            <table class="table text-nowrap table-striped table-hover table-bordered">
                                    ...
                                    <tr>
                                        <th>ID</th>
                                           <th class="text-center">Image</th>
                                            <th class="text-center">Người mua / mã gd </th>
                                ...
                                <tbody>
                                     <?php $i=0; foreach ($VCD->get_list("SELECT * FROM `product_nick` WHERE  `magd` IS NOT NULL OR `magd` != '' AND `username` IS NOT NULL OR `username` != '' AND $where $order_by LIMIT $from,$limit") as $row) {?>
                                                                        <tr>
                                        <td><b>[<?=$row['id'];?>]</b>
                                        </td>
...
</td><td class="text-center">Người mua: <?=$row['username'];?> <br>
                                       Mã gd: <?=$row['magd'];?> 
                                        </td>
