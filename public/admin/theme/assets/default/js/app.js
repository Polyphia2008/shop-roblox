    ...
    const handleToggleSearch = function () {
        ...
        btnElm.click(function () {
            if (wrapperBtnElm.hasClass('is-show')) {
                btnElm.html('<iconify-icon icon="line-md:person-search"  style="color: #cd2d2d"></iconify-icon>');
                wrapperBtnElm.removeClass('is-show');
            } else {
                btnElm.html('<iconify-icon icon="line-md:close-circle"></iconify-icon>');
     ...
     const handleToggleTk = function () {
        let btnElm = $('.btn-call-tk'),
            wrapperBtnElm = btnElm.parent();
        btnElm.click(function () {
            if (wrapperBtnElm.hasClass('dichvuright')) {
                btnElm.html('<iconify-icon icon="line-md:person-search"  style="color: #cd2d2d"></iconify-icon>');
                wrapperBtnElm.removeClass('dichvuright');
            } else {
                btnElm.html('<iconify-icon icon="line-md:close-circle"></iconify-icon>');
                wrapperBtnElm.addClass('dichvuright');
            }
        });
