        ...
        <div class="row">
                            ...
                            <div class="row row-cols-lg-auto g-3 mb-3">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-hero btn-sm btn-primary"><i class="fa fa-search"></i>
                                        Search                                    </button>
                                    <a class="btn btn-hero btn-sm btn-danger" href="/admin/history-order"><i
                                            class="fa fa-trash"></i>
                                        Clear filter                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive mb-3">
                            <table class="table text-nowrap table-striped table-hover table-bordered">
                                <thead>
                                 ...
                                 <tbody>
                                     <?php $i=0; foreach ($VCD->get_list("SELECT * FROM `accountorder` WHERE username IS NOT NULL AND username != '' AND $where $order_by LIMIT $from,$limit") as $rowacc) {?>
                                                                        <tr>
                                        <td><?=$rowacc['id'];?>
                                        </td>
                                        ...
                                        <td class="text-center">
                                          ...
                                          <br>
                                            ...
                                            <i class="fa-solid fa-key"></i> Time mua:
                                            <strong><?=$rowacc['giaohang'];?></strong>
                                       ...
                                       Premium: <?=premium($rowacc['premium']);?> <br>Giao hàng: <?=$rowacc['giaohang'];?> 
                                        ...
                                        <td class="text-center">
                                              <a href="<?=BASE_URL('admin/edit-order-history/')?><?=$rowacc['id']?>" class="btn btn-sm btn-primary shadow-primary btn-wave waves-effect waves-light" data-bs-toggle="tooltip" data-bs-original-title="ADD TK|MK|2FA">
                                                <i class="fa fa-fw fa-edit"></i> Gửi thông tin
                                            </a>
            ...
            <?php } else if ($i <= 4 || $i > $totalPages - 4 || abs($i - $page) <= 1) { ?>
                <li class="page-item <?php if($i == $page) { echo'active';}?>">
                    <a class="page-link link" href="/admin/history-order?id=<?=$id;?>&code=<?=$code;?>&limit=<?=$limit;?>&shortByDate=&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
            ...
            <?php } ?>
        <?php } ?>
        <li class="paginate_button page-item previous "><a class="page-link" href="/admin/history-order?id=<?=$id;?>&code=<?=$code;?>&limit=<?=$limit;?>&shortByDate=&page=<?=$page + 1;?>">Next</a></li>
                                                </ul></div></center>                                    </div>
                                </div>
                            </div>
                        </div>
