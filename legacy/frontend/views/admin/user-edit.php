...
$title = 'Chỉnh Sửa Thành Viên | ' . $VCD->site('title');
$body = [
...
if(isset($_GET['id']))
{
    $row = $VCD->get_row(" SELECT * FROM `users` WHERE `id` = '".check_string($_GET['id'])."'  ");
    if(!$row)
    {
        echo "éo tồn tại";
    }
...
if(isset($_POST['Save']) && $getUser['level'] == 1)
{
    ...
    $isInsert= $VCD->update("users", array(
                                ...
                                <div class="col-md-4">
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="<?=$row['ck_user']?>"
                                                name="ck_user">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="<?=$row['create_date']?>"
                                                disabled>
                                        </div>
                                    </div>
                                </div>
